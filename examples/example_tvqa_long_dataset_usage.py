"""
Example: How to import and use the TVQALong class from other folders
"""
...
# Import the TVQALong class from the datasets package
...
def main():
    # Initialize the dataset (uses default path: datasets/tvqa) or dataset = TVQALong(dataset_path="/path/to/tvqa")
    dataset = TVQALong()
