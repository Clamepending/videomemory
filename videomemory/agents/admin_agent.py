...
admin_agent = Agent(
    ...
    instruction=(
        ...
        "Use stop_task to stop a running task when a user asks to stop, finish, end, or cancel it. "
        "The task and all its notes will remain visible in the tasks list. "
        "Use remove_task ONLY when a user explicitly wants to permanently delete a task and its history. "
