...
```bash
npx -y @clamepending/videomemory@0.1.8 onboard --safe --repo-ref v0.1.4 --videomemory-base http://host.docker.internal:5050
```
...
```bash
npx -y @clamepending/videomemory@0.1.8 relaunch --repo-ref v0.1.4
```
