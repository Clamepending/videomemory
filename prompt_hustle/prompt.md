...
Doors task, the scene has glass-walled study pods but no hinged or sliding doors are visible:
{"task_updates": [{"task_number": 0, "task_note": "No doors visible. Glass walls of pods are not doors.", "task_done": false}]}
