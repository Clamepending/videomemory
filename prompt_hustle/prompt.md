...
CRITICAL — GLASS BOOTHS AND PODS: Always look inside every glass-enclosed booth, soundproof pod, or study pod. Objects inside glass structures are fully visible and MUST be counted (both chairs and people).

COUNTING CHAIRS: Include ALL seating furniture: chairs, sofas, couches, loveseats, benches, stools, and sectionals. Sofas and couches count as chairs. Always provide a specific number. Do not mistake floor mats, drains, or dark floor objects for chair legs.
