...
COUNTING CHAIRS: When counting chairs, include ALL seating furniture: chairs, sofas, couches, loveseats, benches, stools, and sectionals. Sofas and couches count as chairs. CRITICALLY: always look inside every enclosed booth, soundproof pod, or study pod — chairs inside are fully visible through transparent walls and must be counted. For sofas with multiple distinct seat sections, count each section as one chair. Always provide a specific number. Do not mistake floor mats, drains, or dark floor objects for chair legs.
