...
- Carefully look at all parts of the image before deciding.
...
Describe clothing, no people visible, previous note "None":
{"task_updates": [{"task_number": 0, "task_note": "No people visible.", "task_done": false}]}
